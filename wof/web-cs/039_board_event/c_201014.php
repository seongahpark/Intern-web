...
<div style="margin-bottom: 80px; width:100%;">
    <form name="commentform" action="<?=$comment_url?>" method="POST" enctype="multipart/form-data">
		<div style="float: left; width: 100%; margin-top: 20px;">
			<div style="float: left; height: 23px; width: 10%; text-align: center; padding: 10px; background-color: #efefef;">댓글 작성</div>
            ...
            <textarea name="comment" class="comment" id="text" style="resize:none; float: left; width: 70%; margin-left:15px; height: 30px; padding: 5px; "></textarea>
			<!--<input type="submit" class="btn_on b0" value="등록" style="float: right; margin-left: 10px; height: 43px;"/>-->
			<button class="btn_on b0" id="btn" value="등록" style="float: right; margin-left: 10px; height: 43px; border:0;"><span>등록</span></button>
        </div>
    </form>
</div>
