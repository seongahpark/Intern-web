...
<form name="add_form" action="insert_radio.php?" method="post">
<input type="hidden" name="duplicate_check" />
	...
	<tr>
		<th><span>언어</span></th>
		<td colspan="2">
			<input type="radio" name="lang" value="kor" checked="check"/>국문&nbsp;
			<input type="radio" name="lang" value="eng"/>영문&nbsp;
			<input type="radio" name="lang" value="jpn"/>일문&nbsp;
			<input type="radio" name="lang" value="chi"/>중문&nbsp;
		</td>
	</tr>
	<tr>
		...
		<table>
		  ...
		  <tbody>
			  <tr>
				  <th><span>세션명</span></th>
				  <td colspan="3">
				     <input type="text" name="title" title="세션명" placeholder="국문 100자, 영문 200자 이내 입력" style="width:100%"/>
				  </td>
			  </tr>
			   <tr>
				  <th><span>Youtube 주소</span></th>
				  <td><input type="text" name="video" title="유튜브 주소" style="width:100%"/></td>
			  </tr>
			  <tr>
				  <th><span>세션 소개글</span></th>
				  <td>
				  <textarea name="explain" title="세션 소개글" placeholder="국문 500자, 영문 1000자 이내 입력" style="width:100%; height: 100px; resize: none;"></textarea></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				  <th><span>좌장</span></th>
				  <td><input type="text" name="place" title="좌장" style="width:100%;"/></td>
			  </tr>
			  <tr>
				  <th><span>기조연설</span></th>
				  <td>
						<textarea rows="3" name="speech" title="기조연설" style="width:100%; resize: none;"></textarea>
				  </td>
			  </tr>
			  <tr>
				  <th><span>세션기조</span></th>
				  <td>
						<textarea rows="5" name="keynote" title="세션기조" style="width:100%; resize: none;"></textarea>
				  </td>
			  </tr>
			  <tr>
				  <th><span>발제자</span></th>
				  <td>
						<textarea rows="5" name="present" title="발제자" style="width:100%; resize: none;"></textarea>
				  </td>
			  </tr>
			  <tr>
				  <th><span>토론좌장</span></th>
				  <td>
						<input type="text" name="panel" title="토론좌장" style="width:100%;"/>
				  </td>
			  </tr>
			  <tr>
				  <th><span>토론자</span></th>
				  <td>
						<textarea rows="5" name="panelist" title="토론자" style="width:100%; resize: none;"></textarea>
				  </td>
			  </tr>
			  </tbody>
			</table>
